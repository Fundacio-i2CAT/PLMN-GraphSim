...
export PROVINCE_ANCHORS, REFERENCE_CITIES
...
# --- Province Anchors (Geometric Centers for Data Classification) ---
# Used to assign base stations to provinces based on proximity.
# Distinct from K-Means centroids which are dynamically computed for UPF placement.
const PROVINCE_ANCHORS = Dict(
    "Albacete" => GeoPoint(38.9943, -1.8585),
