...
function update_history!(sim_state, current_time, metrics_5g, metrics_6grupa)
    ...
    push!(sim_state.history_max_upf_6grupa_mb, metrics_6grupa.max)
    push!(sim_state.history_mean_upf_6grupa_mb, metrics_6grupa.mean)
    push!(sim_state.history_median_upf_6grupa_mb, metrics_6grupa.median)
    ...
    push!(sim_state.history_per_upf_6grupa_mb, copy(metrics_6grupa.per_upf_mb))
    push!(sim_state.history_per_upf_entries_6grupa, copy(metrics_6grupa.per_upf_entries))
end
