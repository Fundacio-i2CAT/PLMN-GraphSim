...
### 1. Total Network Memory (`total_memory_comparison.png`)
...
### 2. Bottleneck Analysis (`max_memory_per_upf.png`)
...
### 3. Typical Load (`average_memory_per_upf.png` & `median_memory_per_upf.png`)
...
### 4. Baseline Load (`min_memory_per_upf.png`)
